...
const htmlDocument = buildHtmlDocument("Google", exampleBodyHtml);
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
          <div className="min-w-0 w-full flex-1 space-y-3 lg:min-w-[240px]">
            ...
            {phase === "done" ? (
              <div
                className={[
                  "rounded-xl border border-slate-200 overflow-hidden transition-opacity duration-500",
                  animateResponse ? "opacity-100" : "opacity-0",
                ].join(" ")}
              >
                <img
                  src="/assets/google.png"
                  alt="google.com rendered"
          ...
          <div className="relative h-32 w-full min-w-0 overflow-hidden lg:mt-6 lg:min-w-[160px]">
            ...
            <div className="absolute top-1/2 flex w-full -translate-y-1/2 items-center justify-center gap-2">
              {Array.from({ length: 3 }).map((_, index) => (
                <span key={index} className="h-2 w-2 rounded-sm bg-slate-200" />
              ))}
            </div>
            ...
            {packetPosition !== null ? (
              ...
              >
                <div className="text-[9px] font-semibold uppercase tracking-wide">
                  {packetKind === "request" ? "HTTP Request" : "HTTP Response"}
                </div>
          ...
          <div className="min-w-0 w-full flex-1 space-y-3 lg:min-w-[220px]">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-3 text-xs text-slate-600">
              <div className="font-semibold text-slate-700">google.com</div>
              <div className="mt-1 text-[11px] text-slate-500">
                Port 80 - HTTP
              </div>
              <div className="mt-3 rounded-md border border-slate-200 bg-white px-2 py-2">
